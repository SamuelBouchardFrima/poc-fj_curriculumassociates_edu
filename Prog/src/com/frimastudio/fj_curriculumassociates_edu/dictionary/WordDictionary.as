package com.frimastudio.fj_curriculumassociates_edu.dictionary
{
	...
	{
		private static const GRADE_K:XML = new XML("<data>" + (<![CDATA[
			]]>).toString() + "</data>");
		
		private static const GRADE_1:XML = new XML("<data>" + (<![CDATA[
ad
dad
mad
sad
...
duel
		...
		private static const GRADE_2:XML = new XML("<data>" + (<![CDATA[
			]]>).toString() + "</data>");
		
		private static const GRADE_3:XML = new XML("<data>" + (<![CDATA[
			]]>).toString() + "</data>");
		
		private static const GRADE_4:XML = new XML("<data>" + (<![CDATA[
			]]>).toString() + "</data>");
		...
		public static function Validate(aWord:String, aGrade:int):Boolean
		{
			...
			{
				if (sValidatorList[i].Validate(aWord))
				{
					return true;
				}
			}
