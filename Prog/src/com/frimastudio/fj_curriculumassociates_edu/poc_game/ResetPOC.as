package com.frimastudio.fj_curriculumassociates_edu.poc_game
{
	...
	public class ResetPOC extends QuestStep
	{
		private var mTemplate:ResetPOCTemplate;
		private var mBlocker:Sprite;
		
		public function ResetPOC(aTemplate:ResetPOCTemplate)
		{
			super(aTemplate);
			...
			addChild(mBlocker);
			TweenLite.to(mBlocker, 3, { ease:Strong.easeOut, onComplete:OnTweenShowBlocker, alpha:1 });
		}
		...
		private function OnTweenShowBlocker():void
		{
			dispatchEvent(new QuestStepEvent(QuestStepEvent.RESET_POC));
		}
	}
}