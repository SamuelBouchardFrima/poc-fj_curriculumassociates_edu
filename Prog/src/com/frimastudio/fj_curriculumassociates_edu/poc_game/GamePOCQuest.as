	...
	public class GamePOCQuest extends Quest
	{
		public function GamePOCQuest()
		{
			...
			mStepList.push(new DialogTemplate(Level.THEATER, new <String>["You are running out of words."],
				...
				new <WordTemplate>[new MisplacedWordTemplate("but"),
				new MisplacedWordTemplate("I"),
				new MisplacedWordTemplate("sing"),
				new MisplacedWordTemplate("don't"),
				new MisplacedWordTemplate("can"),
				new MisplacedWordTemplate("I"),
			...
			mStepList.push(new DialogTemplate(Level.THEATER, new <String>["Great job!"], new <Class>[Asset.GameHintSound[1]],
				Asset.SentenceContentTargetSound[5],
				new <WordTemplate>[new KnownWordTemplate("I", "", true),
				new KnownWordTemplate("don't", "", true),
				new KnownWordTemplate("sing", "", true),
				new KnownWordTemplate("but", "", true),
				new KnownWordTemplate("I", "", true),
				new KnownWordTemplate("can", "", true),
			...
			mStepList.push(new SelectActivityTemplate(Level.THE_LAB, Asset.SentenceContentTargetSound[8],
				new <WordTemplate>[new MisplacedWordTemplate("take"),
				new ScrambledWordTemplate("it", "ti"),
				new MisplacedWordTemplate("up"),
				new MisplacedWordTemplate("Mix"),
				new MisplacedWordTemplate("a"),
				new MisplacedWordTemplate("and"),
				new ScrambledWordTemplate("sip", "spi", ".")],
				null, Direction.NONE));
